     ...
     <div style={{ padding: '3rem', maxWidth: '1000px', color: '#0f172a', fontFamily: 'system-ui, sans-serif' }}>
       ...
       <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.25rem' }}>
         ...
         <Link to="/ins" style={{ textDecoration: 'none' }}>
           <div style={{ background: '#f8fafc', padding: '1.5rem', borderRadius: '10px', border: '1px solid #e2e8f0', transition: '0.2s' }}>
             <h3 style={{ fontSize: '1.15rem', color: '#1d4ed8', margin: '0 0 0.5rem 0' }}>🏥 Insurance Claims</h3>
         ...
         <Link to="/work" style={{ textDecoration: 'none' }}>
           <div style={{ background: '#f8fafc', padding: '1.5rem', borderRadius: '10px', border: '1px solid #e2e8f0', transition: '0.2s' }}>
             <h3 style={{ fontSize: '1.15rem', color: '#1d4ed8', margin: '0 0 0.5rem 0' }}>💬 Realtime Workspace</h3>
             <p style={{ color: '#64748b', fontSize: '0.9rem', margin: 0 }}>Collaborative WebSockets canvas and chat sync.</p>
           </div>
         </Link>

         {/* Full-Page Reload Card for 23-Microservice Hub */}
         <div 
           onClick={() => window.location.href = "https://portfolio-showcase-hub-web11.vercel.app"} 
           style={{ background: '#eff6ff', padding: '1.5rem', borderRadius: '10px', border: '1px solid #bfdbfe', transition: '0.2s', cursor: 'pointer' }}
         >
           <h3 style={{ fontSize: '1.15rem', color: '#1d4ed8', margin: '0 0 0.5rem 0' }}>🚀 23-Microservice Hub</h3>
           <p style={{ color: '#1e40af', fontSize: '0.9rem', margin: 0 }}>Explore full directory of all 23 backend services (Reloads live hub).</p>
         </div>
       </div>
     </div>
   );
